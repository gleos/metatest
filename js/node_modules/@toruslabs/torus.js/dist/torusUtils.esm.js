...
var Torus = /*#__PURE__*/function () {
  ...
  _createClass(Torus, [{
    ...
    key: "retrieveShares",
    value: function () {
      var _retrieveShares = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(endpoints, indexes, verifier, verifierParams, idToken) {
        var _this = this;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 4:
                ...
                return _context4.abrupt("return", Some(promiseArr, function (resultArr) {
    ...
    key: "getMetadata",
    value: function () {
      var _getMetadata = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(data, options) {
        var _this2 = this;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 14:
                ...
                if (unlock) unlock();
                return _context5.abrupt("return", new BN(0));

              case 19:
                this.metadataCache.put(dataKey, new BN(metadataResponse.message, 16), 60000);
                return _context5.abrupt("return", new BN(metadataResponse.message, 16));

              case 23:
                _context5.prev = 23;
                _context5.t0 = _context5["catch"](0);
                log.error('get metadata error', _context5.t0);
                if (unlock) unlock();
                return _context5.abrupt("return", new BN(0));
    ...
    key: "setMetadata",
    value: function () {
      var _setMetadata = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6(data, options) {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 8:
                ...
                log.error('set metadata error', _context6.t0);
    ...
    value: function () {
      var _getPublicAddress = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7(endpoints, torusNodePubs, _ref6) {
        var verifier,
            verifierId,
            isExtended,
            finalKeyResult,
    ...
    key: "getOrSetNonce",
    value: function () {
      var _getOrSetNonce = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(X, Y, privKey) {
        var getOnly,
            data,
            msg,
            _args8 = arguments;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                ...
                return _context8.abrupt("return", post("".concat(this.metadataHost, "/get_or_set_nonce"), data, undefined, {
                  useAPIKey: true
                }));
    ...
    key: "getNonce",
    value: function () {
      var _getNonce = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9(X, Y, privKey) {
